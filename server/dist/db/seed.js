...
exports.seedRedlines = seedRedlines;
...
function seedRedlines() {
    ...
    VALUES (?, ?, ?, ?, ?, ?)
  `);
    insertRedline.run("RL001", "ECO-001", "生态保护红线-东郊湿地", "ecological", ecologicalBoundary, "严禁建设的生态保护范围");
    insertRedline.run("RL002", "HIS-001", "历史街区保护线-老城南片区", "historic", historicBoundary, "历史风貌建筑保护范围，限高限建");
    insertRedline.run("RL003", "PLN-001", "规划控制线-中心轴带", "planning", planningBoundary, "规划预留通道，禁止违规建设");
