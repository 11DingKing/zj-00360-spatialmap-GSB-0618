...
const usages = ['residential', 'commercial', 'industrial', 'public', 'other'];
const stages = ['planning', 'construction', 'acceptance', 'registration', 'cancelled'];
  ...
  `);
    const tx = db.transaction(() => {
        for (const b of buildings) {
            ...
            const stageOrder = ['planning', 'construction', 'acceptance', 'registration', 'cancelled'];
