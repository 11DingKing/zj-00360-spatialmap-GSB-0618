...
export function seedData(): void {
  ...
  const ecologicalRedline = JSON.stringify({
    type: "Polygon",
    coordinates: [
      [
  ...
  const heritageRedline = JSON.stringify({
    type: "Polygon",
    coordinates: [
      [
        [CENTER_LNG - 0.003, CENTER_LAT - 0.003],
        [CENTER_LNG - 0.001, CENTER_LAT - 0.003],
        [CENTER_LNG - 0.001, CENTER_LAT - 0.001],
  ...
  const waterRedline = JSON.stringify({
    type: "Polygon",
    coordinates: [
      [
        [CENTER_LNG + 0.002, CENTER_LAT - 0.004],
